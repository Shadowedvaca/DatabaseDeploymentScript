...
$databaseNameCore = 'DataValidation'
$prodSuffix = ''
$devSuffix = 'Dev'
...
# Make dv Schema
$schemadv = New-Object -TypeName ("$ns.Schema") -argumentlist $proddb, "dv"
$schemadv.Create()
Clear-Variable -Name "schemadv"
$schemadv = New-Object -TypeName ("$ns.Schema") -argumentlist $devdb, "dv"
$schemadv.Create()
